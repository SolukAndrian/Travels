...
<nav class="navbar navbar-default">
    <div class="container-fluid">
        ...
        <ul class="nav navbar-nav navbar-right">
            ...
            <sec:authorize access="hasRole('ROLE_ADMIN')">
                <li><a href="/hotelAccommodation"><span class="glyphicon glyphicon-plus"></span> Add hotel accommodation</a>
                </li>
            </sec:authorize>
    ...
    <dep:forEach var="dep" items="${departures}">
        <a href="/departure/${dep.id}">
            <div class="tour">
                ...
                <div class="button1">
                    <sec:authorize access="hasRole('ROLE_ADMIN')"><a href="/departureDelete/${dep.id}">
                        <button class="b2"><span class="glyphicon glyphicon-trash"></span>delete</button>
                    </a></sec:authorize>
                    <sec:authorize access="hasRole('ROLE_USER')"><a href="/booking/${dep.id}">
                        <button class="b3">Booking</button>
                    </a></sec:authorize>
                    <sec:authorize access="isAnonymous()"><a href="/loginpage">
                        <button class="b4">Booking</button>
                    </a></sec:authorize>
                </div>
            </div>
        </a>
